...
#' 
#' @param data (\code{data.frame} or \code{tibble}) Data to be used in plot
...
#' 
#' @export
ezplot <- function(data, plot_type = "bar", x, y, group = NULL, group_method = "stack", 
  ...
  checkmate::assert_subset(y, names(data), empty.ok = FALSE)
